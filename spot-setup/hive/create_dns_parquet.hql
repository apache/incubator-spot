...
CREATE EXTERNAL TABLE ${hiveconf:dbname}.dns_dendro (
unix_tstamp BIGINT,
dns_a STRING,
dns_qry_name STRING,
ip_dst STRING
...
CREATE EXTERNAL TABLE ${hiveconf:dbname}.dns_edge ( 
unix_tstamp BIGINT,
frame_len BIGINT,
ip_dst STRING,
ip_src STRING,
...
CREATE EXTERNAL TABLE ${hiveconf:dbname}.dns_ingest_summary ( 
tdate STRING,
total BIGINT
)
PARTITIONED BY (
...
CREATE EXTERNAL TABLE ${hiveconf:dbname}.dns_storyboard ( 
ip_threat STRING,
dns_threat STRING, 
title STRING,
text STRING
...
CREATE EXTERNAL TABLE ${hiveconf:dbname}.dns_threat_dendro (
anchor STRING, 
total BIGINT,
dns_qry_name STRING, 
ip_dst STRING
...
CREATE EXTERNAL TABLE ${hiveconf:dbname}.dns_threat_investigation ( 
unix_tstamp BIGINT,
ip_dst STRING, 
dns_qry_name STRING, 
ip_sev INT,
