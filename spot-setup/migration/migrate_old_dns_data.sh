...
# Execution example:
#./migrate_old_dns_data.sh '/home/spotuser/incubator-spot_old/spot-oa' '/home/spotuser/incubator-spot_new/spot-oa/' 'spot_migration' '/user/spotuser/spot_migration/' 'migrated' 'node01'
...
ing_sum_path=$OLD_OA_PATH/data/dns/ingest_summary/is_??????.csv
...
for new_dir in $NEW_OA_PATH/ipynb/dns/*
do 
  cp $OLD_OA_PATH/oa/dns/ipynb_templates/Advanced_Mode_master.ipynb $new_dir/Advanced_Mode.ipynb
done
...
mv $OLD_OA_PATH/data/dns/ $OLD_OA_PATH/data/backup/
